...
Required by SME's sanity check #2 (single source here, but
...
Median brooks_tax is the calibration value for `models/sd.py:brooks()`.
...
fwrite(out, "../../core/paper/outputs/lift_brooks_helix.csv")
kable(out)
```
